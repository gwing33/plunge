...
class PlungeContext {
  ...
  fetch(options = {}) {
    if(this.api.get) {
      ...
      this.apiReturn( this.api.get(options), { isFetching: false });
    }
  }
  ...
  save(options = {}) {
    if(this.api.save) {
      ...
      this.apiReturn( this.api.save(options), { isSaving: false });
    }
  }
  ...
  create(options = {}) {
    if(this.api.create) {
      ...
      this.apiReturn( this.api.create(options), { isCreating: false });
    }
  }
  ...
  del(options = {}) {
    if(this.api.del) {
      ...
      this.apiReturn( this.api.del(options), { isDeleting: false });
    }
  }
  ...
  apiReturn(apiPromise, data) {
    apiPromise.then((res) => {
              ...
              .catch((err) => {
                this.add(_.merge({ hasError: true }, data, err));
              });
  }
}
